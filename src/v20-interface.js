(function(){
  ...
  function render(){
    ...
    const actions=$('v19PaneActions');if(actions)actions.innerHTML=`
      ...
      ${group('Tienda',[
        {view:'invoices',icon:'🧾',label:'Facturas y compras',description:'Proveedores, vencimientos y pagos'}
      ])}
